...
export async function db() {
    try {
        ...
        async function dbTransaction<DataType = any>(
            sql: string,
            variables: any[] = [],
        ) {
        ...
        await createTablesIfNotExist(dbTransaction);
...
export async function createTablesIfNotExist(dbTransaction: (sql: string) => Promise<any>) {
