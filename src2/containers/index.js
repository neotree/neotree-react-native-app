...
const SetLocationScreen = LazyPage(() => import('@/components/SetLocationScreen'));

const Containers = () => {
  const { state: { authenticatedUser, dataInitialised } } = useAppContext();
  ...
  if (authenticatedUser && !dataInitialised) return <SetLocationScreen />;
